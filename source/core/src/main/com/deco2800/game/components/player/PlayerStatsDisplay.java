...
public class PlayerStatsDisplay extends UIComponent {
  ...
  public void draw(SpriteBatch batch)  {
    ...
    if (health>81 && health <=91){
      TextureRegion h90 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>71 && health <=81){
      TextureRegion h80 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>61 && health <=71){
      TextureRegion h70 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>51 && health <=61){
      TextureRegion h10 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>41 && health <=51){
      TextureRegion h60 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>31 && health <=41){
      TextureRegion h50 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>21 && health <=31){
      TextureRegion h40 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>11 && health <=21){
      TextureRegion h30 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health>1 && health <=11){
      TextureRegion h20 = new TextureRegion(pixmaptex, 3, 1);
    ...
    if (health<=1){
      TextureRegion h00 = new TextureRegion(pixmaptex, 3, 1);
